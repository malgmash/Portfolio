        ...
        {experience.map((entry) => (
          <li key={entry.title} className="relative">
            <span
              ...
              aria-hidden="true"
            />
            <div className={entry.image ? "sm:flex sm:items-stretch sm:gap-8" : undefined}>
              <div className={entry.image ? "sm:min-w-0 sm:flex-1" : undefined}>
              ...
              {entry.image ? (
                <div className="relative mt-4 aspect-[4/3] w-full shrink-0 overflow-hidden rounded-xl border border-border sm:mt-0 sm:aspect-auto sm:w-48 md:w-56">
                  <Image
                    src={entry.image.src}
                    alt={entry.image.alt}
                    fill
